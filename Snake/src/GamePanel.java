...
public class GamePanel extends JPanel implements ActionListener {
	...
	public void draw(Graphics g) {
		if (running) {
			/*
			 * //Draw grid for reference for(int i = 0; i<SCREEN_HEIGHT /
			 * UNIT_SIZE; i++) { g.drawLine(i*UNIT_SIZE, 0, i*UNIT_SIZE,
			 * SCREEN_HEIGHT); g.drawLine(0, i*UNIT_SIZE, SCREEN_WIDTH,
			 * i*UNIT_SIZE); }
			 */
	...
	public void gameOver(Graphics g) {
		...
		g.drawString("Score: " + applesEaten,
				(SCREEN_WIDTH - metrics2.stringWidth("Score: " + applesEaten))
						/ 2,
				g.getFont().getSize());
	}
